...
const TaskGroupView = ({ taskTitle, completed, link }) => {
  return (
      <div className="task dark:bg-neutral-800 bg-light-gray-03 transition-colors p-4 py-4 cursor-pointer hover:bg-dark-gray-05 duration-200 hover:border-dark-gray-04 border mb-1 border-neutral-800 rounded-lg flex  align-middle justify-between">
